            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="{{ url("/lamaran") }}">Riwayat Pekerjaan</a></li>
                        {{-- <li>
                        ...
                        <li class="dropdown" style="background: none !important;">
                            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <div class="img-rounded profile-img"><img src="{{ asset("storage/". auth()->user()->foto) }}" style="border-radius: 50%; height: 3rem;" alt="tidak ada poto"> </div>
                                {{ auth()->user()->username}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="lg-frm form-valide" action="/register" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row has-success">
                        <label for="tamatan_pendidikan" class="col-lg-4 col-form-label">Tamatan Pendidikan</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row has-success">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="keahlian" class="form-control" id="keahlian" placeholder="Enter Keahlian">
                        </div>
                    </div>
                    ...
                    <div class="form-group row has-success">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="file" name="foto" class="form-control-file" id="foto" onchange="previewImage()" accept="doc,pdf,rtf,docx">
