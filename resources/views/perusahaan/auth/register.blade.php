                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="/perusahaan/register" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="nama_perusahaan" class="form-control form-control-user" id="exampleFirstName" placeholder="Nama Perusahaan" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" name="email" class="form-control form-control-user" id="exampleLastName" placeholder="Email Perusahaan" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="alamat" class="form-control form-control-user" id="exampleLastName" placeholder="Alamat Perusahaan" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="number" name="no_telp" class="form-control form-control-user" id="exampleInputEmail" placeholder="Telpon Perusahaan" required>
                                </div>
                                <div class="form-group row">
                                    <!--  <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Password" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Upload SIUP</label>
                                    <input type="file" name="gambar" class="form-control" placeholder="Upload SIUP" required>
                                </div>
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ url('perusahaan/login') }}">Sudah Memiliki Akun? Silahkan Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
